...
void loop(){
  ...
  if (start == 2){                                                          //The motors are started.
    ...
    esc_2 = throttle + pid_output_roll - pid_output_yaw;
    ...
    esc_5 = throttle - pid_output_roll + pid_output_yaw;
  ...
  while(PORTD >= 16){                                                       //Stay in this loop until output 4,5,6 and 7 are low.
    ...
    if(timer_channel_1 <= esc_loop_timer)PORTD &= B11111110;                //Set digital output 22 to low if the time is expired.
    if(timer_channel_2 <= esc_loop_timer)PORTD &= B11111101;                //Set digital output 23 to low if the time is expired.
    if(timer_channel_3 <= esc_loop_timer)PORTD &= B11111011;                //Set digital output 24 to low if the time is expired.
    if(timer_channel_4 <= esc_loop_timer)PORTD &= B11110111;                //Set digital output 25 to low if the time is expired.
    if(timer_channel_5 <= esc_loop_timer)PORTD &= B11101111;                //Set digital output 26 to low if the time is expired.
    if(timer_channel_6 <= esc_loop_timer)PORTD &= B11011111;                //Set digital output 27 to low if the time is expired.
  }
}
...
ISR(PCINT0_vect){
  ...
  else if(last_channel_6 == 1){                                             //Input 13 is not high and changed from 1 to 0.
